...
const corteCajaSchema = new mongoose.Schema(
  {
    ...
    propinasEfectivo: { type: Number, required: true, default: 0 },
    propinasTransferencia: { type: Number, required: true, default: 0 },
    totalPropinas: { type: Number, required: true, default: 0 },
